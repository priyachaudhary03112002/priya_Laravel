        ...
        <div class="row"> 
          <div class="col-lg-8 ftco-animate">
				<div class="row">
		            ...
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="{{url('blog-single/'.$d->id)}}" class="block-20" ><img class="img-fluid" src="{{url('backend/assets/img/upload/blog/'.$d->img)}}" alt="Colorlib Template">
		              </a>
		              <div class="text d-block pl-md-4">
		                ...
		                <p><a href="{{url('blog-single/'.$d->id)}}" class="btn btn-primary py-2 px-3">Read more</a></p>
		              </div>
		            </div>
		          </div>
				  @endforeach
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <ul class="categories">
                <li><a href="#">Skin <span>(12)</span></a></li>
                <li><a href="#">Nails <span>(22)</span></a></li>
                <li><a href="#">Spa <span>(37)</span></a></li>
                <li><a href="#">Makeup <span>(42)</span></a></li>
              </ul>
            </div>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{url('frontend/images/img1.jpg')}});"></a>
                <div class="text">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{url('frontend/images/img2.jpg')}});"></a>
                <div class="text">
                  <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> April 09, 2019</a></div>
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{url('frontend/images/img3.jpg')}});"></a>
                <div class="text">
                  <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> April 09, 2019</a></div>

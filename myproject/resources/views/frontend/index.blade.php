	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Beauty &amp; Care</h1>
	              <h2 class="subheading mb-4">Nourish your skin with toxin-free cosmetic products.<br>
					 With the offers that you can’t refuse.</h2>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">Look &amp; Feel Modern</h1>
	              <h2 class="subheading mb-4">Cosmetics By Viasun</h2>
	              <p><a href="#" class="btn btn-primary">View Details</a></p>
	            </div>
		...
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url({{url('frontend/images/nails.jpg')}});">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Nails</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{url('frontend/images/spa.jpg')}});">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Spa</a></h2>
							</div>		
						</div>
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="{{url('frontend/images/product-55.jpg')}}" alt="Colorlib Template">
    						<span class="status">30%</span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#"> SPF30+ BB Cream</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">$120.00</span><span class="price-sale">$80.00</span></p>
		    					</div>

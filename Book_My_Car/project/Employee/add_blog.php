                        ...
                        <div class="panel-body">
                            <form role="form" method="post" enctype="multipart/form-data">
                                        <div class="form-group has-success has-feedback">
                                            ...
                                            <input class="form-control" name='Title' type="text" placeholder="Enter Alphabets Only"  required="required"  />
                                        ...
                                        <div class="form-group  has-success has-feedback">
                                            ...
                                            <input class="form-control" name='Description' type="text" placeholder="Enter Alphabets Only"   required="required" />
                                            <span class="glyphicon glyphicon-ok form-control-feedback"></span>
                                            <p class="help-block"></p>
                                        </div>

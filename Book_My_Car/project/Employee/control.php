...
include_once('../Employee/model.php');
    class control extends model
    {
        function __construct()
        {
            ...
            switch($path)
            {
				...
				{
					echo "<script>
						alert('Car Category Added Succesfully');
				...
				{
					echo "<script>
						alert('Car Category Not Added Succesfully');
					</script>";
				}
				...
				{
					echo "<script>
						alert('Location Not Added Successfully');
					</script>";
				}
                        ...
                        if(isset($_REQUEST['btn_car_adv_id']))
			{
				...
				if($res)
				{
					unlink('../website/img/upload/customer/'.$del_img);// delete img from path 
					echo "<script>
					alert('Car Advertisement Deleted Successfully');

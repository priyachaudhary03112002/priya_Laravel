 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li class="sidebar-header">Form & Table</li>
      <li>
        <a href="icons.html">
          <i class="zmdi zmdi-invert-colors"></i> <span>Gallery</span>
        </a>
      </li>

      <ul class="menu-sub">
      <li class="menu-iteam">
        <a href="add_gallery" class="menu-link">
           <span>add gallery</span>
        </a>
      </li>

      <li class="menu-iteam">
        <a href="manage_gallery" class="menu-link">
